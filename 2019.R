...
caged_folder <- '/home/andremenegatti/Desktop/USP_Municipios/CAGED/Clean'

#### IMPORTANDO DADOS ####
df_caged <- read_caged_rds(data_folder = caged_folder,
                           start = '2019-01',
                           end = '2019-10',
                           nested = FALSE,
...
map1 <- reg_gov_salario %>%
  ...
  add_geometry_regioes_gov() %>%
  map_regions_divergent(var_plot = 'Saldo (milhares de R$)',
...
# tmap_save(map1, filename = 'mapa_massa_salarial_absoluta_2019.png', width = 7, height = 5.5)

# Saldo de vagas
map2 <- map_regions_divergent(sp_sf_gov,
...
# tmap_save(map4, filename = 'mapa_salarios_criados_2019.png', width = 7, height = 5.5)
